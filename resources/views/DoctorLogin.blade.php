                                            ...
                                            <form action="{{ route('Doctor-Login') }}" method="post"
                                                ...
                                                <div class="d-flex flex-row align-items-center mb-4">
                                                    ...
                                                    <div class="form-outline flex-fill mb-0">
                                                        <input type="password" id="form3Example4c"
                                                            class="form-control" name="password" value="{{ old('password') }}" placeholder=" Enter Passwrod" />
                                                        @error('password')
                                                            <span class="error">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="form-check d-flex justify-content-center mb-5 text-center">
                                                    <label class="form-check-label" for="form2Example3">
                                                        Don't Have Medicare Account ? <a href="DoctorRegister">Register here</a>
                                                    </label>
                                                </div>
