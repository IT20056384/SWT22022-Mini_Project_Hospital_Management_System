...
<head>
    ...
    <title>MediCare | Employee Register</title>
                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <form action="{{ route('Employee-register') }}" method="post" class="mx-1 mx-md-4">
                                    @csrf
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        <i class="fas fa-user-nurse fa-lg me-3 fa-fw"></i>
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            ...
                                            <select name="section" id="section" class="form-select">
                                                <option value="">Select..</option>
                                                <option value="Emergency Department (ED)">Emergency Department (ED)
                                                </option>
                                                <option value="Outpatient Departments (OPD)">Laboratorist</option>
                                                <option value="Inpatient Unit">Inpatient Unit</option>
                                                <option value="Pharmacy">Pharmacist</option>
                                                <option value="	Laboratories">Receptionist</option>
                                                <option value="Medical Records Department">Medical Records Department
                                                </option>
                                    ...
                                    <div class="form-check d-flex justify-content-center mb-5 text-center">
                                        <label class="form-check-label" for="form2Example3">
                                            Have already an account ? <a href="EmployeeLogin">Login here</a>
                                        </label>
                                    </div>
