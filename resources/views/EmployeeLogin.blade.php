...
<head>
    ...
    <title>MediCare | Employee Login</title>
                            ...
                            <div class="col-lg-12 col-xl-11">
                                <div class="card-body p-md-5">
                                    <div class="row justify-content-center">
                                            ...
                                            <form action="{{ route('Employee-login') }}" method="post"
                                                ...
                                                <div class="d-flex justify-content-center mx-6 mb-3 mb-lg-4">
                                                    <input type="submit" name="submit" id="submit"
                                                        value="Login" class="btn btn-primary btn-lg btn-block re" style="width: 100%;">
                                                </div>

                                                <div class="form-check d-flex justify-content-center mb-5 text-center">
                                                    <label class="form-check-label" for="form2Example3">
                                                        Don't Have Medicare Account ? <a href="EmployeeRegister">Register here</a>
                                                    </label>
                                                </div>
                                        ...
                                        <div
                                            class="col-md-10 col-lg-6 col-xl-5 d-flex align-items-center justify-content-center order-1 order-lg-2">

                                            <img src="img/emlog.png"
                                                class="img-fluid" alt="Sample image" width="90%">
