...
<head>
    ...
    <title>MediCare | EmployeeDashboard</title>
                                    ...
                                    <tbody>
                                        @foreach ($bookings as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->time }}</td>
                                                <td>
                                                    <a href="{{ url('edit-booking/'.$item->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                                </td>
                                                <td>
                                                    <a href="{{ url('delete-booking/'.$item->id) }}" class="btn btn-danger btn-sm">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
